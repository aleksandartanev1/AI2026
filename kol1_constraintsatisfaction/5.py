...
if __name__ == '__main__':
    ...
    problem.addConstraint(lambda m, s, p: m + p >= 1, ["Marija_attendance", "Simona_attendance", "Petar_attendance"])
    ...
    problem.addConstraint(marija, ["Marija_attendance", "time_meeting"])
